...
export default function Header3({ headerCls, scroll, isToggled, handleToggle }) {
    ...
    return (
        <>
            <header id="header-3" className={`header navik-header header-transparent header-shadow viewport-lg ${headerCls ? headerCls : ""} ${scroll ? "sticky" : "header-transparent-on"}`}>
